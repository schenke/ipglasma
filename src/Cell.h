...
private:
  ...
  Matrix* Ux1;   // U is in the fundamental rep. (Nc*Nc matrix) nucleus 1 (also room to save g, the gauge fixing matrix)
  Matrix* Uy1;   // U is in the fundamental rep. (Nc*Nc matrix) nucleus 1 (also room to save Uplaq, the plaquette)
  
  Matrix* Ux2;   // U is in the fundamental rep. (Nc*Nc matrix) nucleus 2 (doubles as longitudinal electric field pi)
  Matrix* Uy2;   // U is in the fundamental rep. (Nc*Nc matrix) nucleus 2 (doubles as scalar field (longitudinal) )
...
public:
  ...
  void setUplaq(const Matrix& x) { *Uy1 = x; }; //using unused Uy1 to store Uplaq
