...
double kkp(int ih, int iset, double x, double qs) {
  ...
  if (iset == 0) {
    ...
    a[10] = 0.23086;
    a[11] = -0.29182;
    dpg = (b[1] + a[1] * s + a[2] * s * s + a[3] * s * s * s) *
          pow(x, (b[2] + a[4] * s + a[5] * s * s + a[6] * s * s * s)) *
          pow((1. - x), (b[3] + a[7] * s + a[8] * s * s + a[9] * s * s * s)) *
          (1. + (a[10] * s + a[11] * s * s) / x);
    b[1] = 0.54610;
    b[2] = -1.46616;
    b[3] = 1.01864;
    ...
    a[10] = -0.01877;
    a[11] = 0.02949;
    dpu = (b[1] + a[1] * s + a[2] * s * s + a[3] * s * s * s) *
          pow(x, (b[2] + a[4] * s + a[5] * s * s + a[6] * s * s * s)) *
          pow((1. - x), (b[3] + a[7] * s + a[8] * s * s + a[9] * s * s * s)) *
          (1. + (a[10] * s + a[11] * s * s) / x);
    ...
    a[10] = 0.09044;
    a[11] = -0.07589;
    dps = (b[1] + a[1] * s + a[2] * s * s + a[3] * s * s * s) *
          pow(x, (b[2] + a[4] * s + a[5] * s * s + a[6] * s * s * s)) *
          pow((1. - x), (b[3] + a[7] * s + a[8] * s * s + a[9] * s * s * s)) *
          (1. + (a[10] * s + a[11] * s * s) / x);
    ...
    a[10] = 0.06652;
    a[11] = -0.05531;
    dpc = (b[1] + a[1] * sc + a[2] * sc * sc + a[3] * sc * sc * sc) *
          pow(x, (b[2] + a[4] * sc + a[5] * sc * sc + a[6] * sc * sc * sc)) *
          pow((1. - x),
              (b[3] + a[7] * sc + a[8] * sc * sc + a[9] * sc * sc * sc)) *
          (1. + (a[10] * sc + a[11] * sc * sc) / x);
    ...
    a[10] = -0.04887;
    a[11] = 0.03212;
    dpb = (b[1] + a[1] * sb + a[2] * sb * sb + a[3] * sb * sb * sb) *
          pow(x, (b[2] + a[4] * sb + a[5] * sb * sb + a[6] * sb * sb * sb)) *
          pow((1. - x),
              (b[3] + a[7] * sb + a[8] * sb * sb + a[9] * sb * sb * sb)) *
          (1. + (a[10] * sb + a[11] * sb * sb) / x);
    ...
    a[10] = 0.03586;
    a[11] = -0.01220;
    dkg = (b[1] + a[1] * s + a[2] * s * s + a[3] * s * s * s) *
          pow(x, (b[2] + a[4] * s + a[5] * s * s + a[6] * s * s * s)) *
          pow((1. - x), (b[3] + a[7] * s + a[8] * s * s + a[9] * s * s * s)) *
          (1. + (a[10] * s + a[11] * s * s) / x);
    ...
    a[10] = 0.15303;
    a[11] = 0.14807;
    dku = (b[1] + a[1] * s + a[2] * s * s + a[3] * s * s * s) *
          pow(x, (b[2] + a[4] * s + a[5] * s * s + a[6] * s * s * s)) *
          pow((1. - x), (b[3] + a[7] * s + a[8] * s * s + a[9] * s * s * s)) *
          (1. + (a[10] * s + a[11] * s * s) / x);
    ...
    a[10] = 0.05141;
    a[11] = -0.00697;
    dkd = (b[1] + a[1] * s + a[2] * s * s + a[3] * s * s * s) *
          pow(x, (b[2] + a[4] * s + a[5] * s * s + a[6] * s * s * s)) *
          pow((1. - x), (b[3] + a[7] * s + a[8] * s * s + a[9] * s * s * s)) *
          (1. + (a[10] * s + a[11] * s * s) / x);
    ...
    a[10] = 0.13514;
    a[11] = -0.17778;
    dkc = (b[1] + a[1] * sc + a[2] * sc * sc + a[3] * sc * sc * sc) *
          pow(x, (b[2] + a[4] * sc + a[5] * sc * sc + a[6] * sc * sc * sc)) *
          pow((1. - x),
              (b[3] + a[7] * sc + a[8] * sc * sc + a[9] * sc * sc * sc)) *
          (1. + (a[10] * sc + a[11] * sc * sc) / x);
    ...
    a[10] = 0.01024;
    a[11] = -0.06160;
    dkb = (b[1] + a[1] * sb + a[2] * sb * sb + a[3] * sb * sb * sb) *
          pow(x, (b[2] + a[4] * sb + a[5] * sb * sb + a[6] * sb * sb * sb)) *
          pow((1. - x),
              (b[3] + a[7] * sb + a[8] * sb * sb + a[9] * sb * sb * sb)) *
          (1. + (a[10] * sb + a[11] * sb * sb) / x);
    ...
    a[10] = 1.26515;
    a[11] = -1.96117;
    dprg = (b[1] + a[1] * s + a[2] * s * s + a[3] * s * s * s) *
           pow(x, (b[2] + a[4] * s + a[5] * s * s + a[6] * s * s * s)) *
           pow((1. - x), (b[3] + a[7] * s + a[8] * s * s + a[9] * s * s * s)) *
           (1. + (a[10] * s + a[11] * s * s + 0.54769 * s * s * s) / x);
    ...
    a[10] = 0.05198;
    a[11] = -0.04623;
    dpru = (b[1] + a[1] * s + a[2] * s * s + a[3] * s * s * s) *
           pow(x, (b[2] + a[4] * s + a[5] * s * s + a[6] * s * s * s)) *
           pow((1. - x), (b[3] + a[7] * s + a[8] * s * s + a[9] * s * s * s)) *
           (1. + (a[10] * s + a[11] * s * s) / x);
    ...
    a[10] = 0.07174;
    a[11] = -0.08321;
    dprs = (b[1] + a[1] * s + a[2] * s * s + a[3] * s * s * s) *
           pow(x, (b[2] + a[4] * s + a[5] * s * s + a[6] * s * s * s)) *
           pow((1. - x), (b[3] + a[7] * s + a[8] * s * s + a[9] * s * s * s)) *
           (1. + (a[10] * s + a[11] * s * s) / x);
    ...
    a[10] = 0.00831;
    a[11] = 0.00065;
    dprc = (b[1] + a[1] * sc + a[2] * sc * sc + a[3] * sc * sc * sc) *
           pow(x, (b[2] + a[4] * sc + a[5] * sc * sc + a[6] * sc * sc * sc)) *
           pow((1. - x),
               (b[3] + a[7] * sc + a[8] * sc * sc + a[9] * sc * sc * sc)) *
           (1. + (a[10] * sc + a[11] * sc * sc) / x);
    ...
    a[10] = -0.04290;
    a[11] = -0.30359;
    dprb = (b[1] + a[1] * sb + a[2] * sb * sb + a[3] * sb * sb * sb) *
           pow(x, (b[2] + a[4] * sb + a[5] * sb * sb + a[6] * sb * sb * sb)) *
           pow((1. - x),
               (b[3] + a[7] * sb + a[8] * sb * sb + a[9] * sb * sb * sb)) *
           (1. + (a[10] * sb + a[11] * sb * sb) / x);
