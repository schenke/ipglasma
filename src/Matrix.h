...
public:
    ...
    vector<complex<double> > expmCoeff(double *Q, int n); // Matrix exponential of traceless hermitian matrix using coefficients of t^a as input
      ...
      if(ndim == 3)
	{
	  ...
	  e[3] = e2(0); e[4] = e2(1); e[5] = e2(2);
	  e[6] = e3(0); e[7] = e3(1); e[8] = e3(2);
	}
      else if (ndim == 2)
	{
	  Spinor e1(ndim);
